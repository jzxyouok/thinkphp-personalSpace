                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                             <button type="button" class="btn btn-info" onClick="window.location.href='<?php echo U('User/lists');?>'"><i class="icon-refresh"></i>普通用户</button>
                          </header>
                    ...
                    <?php if(is_array($data)): $key = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr class="odd gradeX">
                              ...
                              <td class="center hidden-phone"><?php echo (date('Y-m-d',$vo["lasttime"])); ?></td>
                              <td class="hidden-phone">
                                   <span class="label label-info" style="cursor:pointer;" onClick="window.location.href='<?php echo U('User/updateadmin','','');?>/id/<?php echo ($vo["id"]); ?>'">修改</span>
                                   <span class="label label-danger" style="cursor:pointer;" onClick="window.location.href='<?php echo U('User/deleteadmin','','');?>/id/<?php echo ($vo["id"]); ?>'">删除</span>
                              </td>
