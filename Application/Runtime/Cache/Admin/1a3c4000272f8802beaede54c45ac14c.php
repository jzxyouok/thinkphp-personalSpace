              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a class="" href="<?php echo U('Admin/Image/typelist');?>">分类管理</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                ...
                <form role="form">
                    <div class="form-group">
                        ...
                        <select class="form-control m-bot15" id="typeid" name="typeid">
                          <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i;?><option value="<?php echo ($res["id"]); ?>"><?php echo ($res["type"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                    <div class="form-group">
...
///*添加分类*///
    function addtype(){
		...
		var ajaxaddtypeUrl='<?php echo U("Image/addtype");?>'; 
    if(type==''){
      layer.msg('请输入分类名称');
      return false;
    }
  ...
  <script type="text/javascript">
   ...
   function edittype(){
      ...
      var ajaxedittypeUrl='<?php echo U("Image/edittype");?>'; 
      if(newtype==''){
          layer.msg('请输入分类名称');
          return false;
      }
...
///*删除分类*///
    function deletetype(){
       var tid=$('#typeid').val();
       var ajaxdeletetypeUrl='<?php echo U("Image/deletetype");?>'; 
        //ajax提交//
      $.ajax({
      //提交数据的类型 POST GET
        type: "POST",
