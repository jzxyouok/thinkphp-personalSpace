              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu  active">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a class="" href="<?php echo U('Admin/Setting/indexlst');?>">底部设置</a></li>
                      </ul>
                  </li>
                  <li>
          ...
          <section class="wrapper">
              ...
              <!--普通用户添加-->
                  <div class="col-lg-6">
                    ...
                    <form role="form" action="<?php echo U('Setting/addvideo');?>" enctype="multipart/form-data" method="post">
                      <div class="form-group">
                        <label for="">首页网站底部视频:</label>
                ...
                <!--普通用户添加-->
                  ...
                  <section class="panel">
                          ...
                          <div class="panel-body">
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><link href="/Public/video/css/video-js.css" rel="stylesheet">
