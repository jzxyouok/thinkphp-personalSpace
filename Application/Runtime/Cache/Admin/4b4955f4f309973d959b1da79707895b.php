              ...
              <ul class="nav pull-right top-menu">
                  ...
                  <li class="dropdown">
                      ...
                      <ul class="dropdown-menu extended logout">
                          ...
                          <li><a data-toggle="modal" data-target="#editpwd"><i class="icon-cog"></i> 密码</a></li>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu  active">
                      ...
                      <ul class="sub">
                          <li class="active"><a class="" href="<?php echo U('Admin/Setting/lunbo');?>">轮播设置</a></li>
              ...
              <div class="row">
                  <div class="col-lg-12">
                    ...
                    <?php if(is_array($data)): $key = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr class="odd gradeX">
                              <td><?php echo ($key); ?></td>
                              <td>
                                <img src="/Public/img/uploads/lunbo/<?php echo ($vo["img"]); ?>" alt="..." class="img-thumbnail" style="width: 120px;height: 70px;">
                              </td>
      ...
      <div class="panel-body">
        <form role="form" action="<?php echo U('Setting/addlunbo');?>" enctype="multipart/form-data" method="post">
           ...
           <div class="form-group">
              ...
              <p class="help-block">图片大小建议719*421</p>
           </div>
