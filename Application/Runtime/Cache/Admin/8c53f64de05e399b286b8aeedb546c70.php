          ...
          <section class="wrapper">
              ...
              <div class="row">
                ...
                <!--图片总类-->
                      ...
                      <?php if(is_array($imgtype)): $key = 0; $__LIST__ = $imgtype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$types): $mod = ($key % 2 );++$key; if($key == 1): ?><div class='external-event label label-primary' style="cursor:default ">
                            <span style="cursor:pointer" onClick="window.location.href='<?php echo U('Image/imglist','','');?>/mid/<?php echo ($types["id"]); ?>'"><?php echo ($types["type"]); ?></span></div>
                         <?php elseif($key == 2): ?>
                         ...
                         <?php else: ?>
                            ...
                            <span style="cursor:pointer" onClick="window.location.href='<?php echo U('Image/imglist','','');?>/mid/<?php echo ($types["id"]); ?>'"><?php echo ($types["type"]); ?></span></div><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                       <!--
                  ...
                  <aside class="col-lg-9">
                      <section class="panel">
                          <div class="panel-body">
                              <div class="panel-body">
                                 <button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal">新增相册</button>
                              </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
   ...
   <form role="form" action="<?php echo U('Image/addalumb');?>" enctype="multipart/form-data" method="post">
      <div class="modal-body">
        <!--内容区-->
            <div class="form-group">
               <label for="exampleInputEmail1">相册名</label>
               <input type="text" class="form-control" id="alumbname" name="alumbname" placeholder="相册名">
            </div>
            <div class="form-group">
               <label for="exampleInputFile">相册封面</label>
