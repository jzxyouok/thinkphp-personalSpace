...
<html lang="en">
          ...
          <div class="row">
            <div id="crop-avatar" class="col-md-6">
              <div class="avatar-view" style="width:60px;height:60px">
                ...
                <input  id="img_root_url" type="hidden" value="/Public/img/uploads/alumb">
                <img src="/Public/img/uploads/alumb/<?php echo ($ab["img"]); ?>" alt="点击修改图片" style="width:60px;height:60px">
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="bs-example" data-example-id="thumbnails-with-custom-content">
    <div class="row">
    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><div class="col-sm-6 col-md-4" style="width: 185px;height: 190px;">
        <div class="thumbnail">
          <img src="/Public/img/uploads/imgs/<?php echo ($vo["img"]); ?>" alt="" data-holder-rendered="true" style="height: 120px; width: 120px; display: block;">
          <div class="caption" style="padding-left:15px;">
            <p><a href="#" class="btn btn-primary" role="button" onClick="window.location.href='<?php echo U('Image/update','','');?>/id/<?php echo ($vo["id"]); ?>'">修改</a> 
...
<div class="modal fade" id="avatar-modal" aria-hidden="true" aria-labelledby="avatar-modal-label" role="dialog" tabindex="-1">
  <div class="modal-dialog modal-lg"  style="width:1000px;">
    <div class="modal-content">
      <form class="avatar-form" action="<?php echo U('Image/postalubmimg',array('id'=>$aid));?>" enctype="multipart/form-data" method="post">
