...
a:hover, a:visited,a:link,a:active {
  ...
  <section id="container" class="">
      ...
      <header class="header white-bg">
        ...
        <!--logo start-->
        <a href="#" class="logo" ><span>香香</span>球球</span></a>
        <!--logo end-->
                  ...
                  <aside class="sm-side">
                      <div class="user-head">
                          <a href="javascript:;" class="inbox-avatar">
                              <img src="/Public/img/uploads/admin/<?php echo ($_SESSION['adminimg']); ?>" style="width: 65px;height: 60px;" alt="">
                          </a>
                          <div class="user-name">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal" role="form">
              ...
              <!-- 回复留言结束 -->
                      <ul class="inbox-nav inbox-divider">
                          ...
                          <li>
                              <a href="<?php echo U('Message/lst');?>?all=1"><i class="icon-envelope-alt"></i>留言箱</a>
                          </li>
                          <li>
                              <a href="<?php echo U('Message/lst');?>?isstatus=1"><i class=" icon-external-link"></i>已回复留言 </a>
                          </li>
                          <li>
                ...
                <li> <a href="<?php echo U('Message/lst');?>?groupid=<?php echo ($vo["id"]); ?>"> <i class=" icon-sign-blank text-primary "></i><?php echo ($vo["name"]); ?></a>
                  ...
                  <aside class="lg-side">
                      <div class="inbox-head">
                          <h3>留言箱</h3>
                          <form class="pull-right position" action="/Admin/Message/lst.html">
                              <div class="input-append">
                                  <input type="text"  placeholder="搜索留言" class="sr-input" id="title" name="title">
            ...
            <?php if($isgroup == 0): if(is_array($data)): $key = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr class="">
                                <td class="inbox-small-cells">
            ...
            <?php else: ?>
                          <?php if(is_array($data)): $key = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key; if($vo["grouid"] == 1): ?><tr class="">
                                <td class="inbox-small-cells">
                                <a href="<?php echo U('Admin/Message/remess','','');?>/id/<?php echo ($vo["id"]); ?>"><?php echo ($key); echo ($vo["usergroupid"]); ?></a>
                                </td>
                                <td class="inbox-small-cells">
                            <?php if($vo["status"] == 2): ?><a href="<?php echo U('Admin/Message/remess','','');?>/id/<?php echo ($vo["id"]); ?>">
                              <i class="icon-star"></i>
