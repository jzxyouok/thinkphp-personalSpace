                          ...
                          <div class="panel-body">
                           <?php if(is_array($date)): $i = 0; $__LIST__ = $date;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><form role="form">
                                    ...
                                    <div class="row">
                                       <div id="crop-avatar" class="col-md-6">
                                        <div class="avatar-view" style="width:60px;height:60px">
                                          ...
                                          <input  id="img_root_url" type="hidden" value="/Public/img/uploads/userimg">
                                          <img src="/Public/img/uploads/userimg/<?php echo ($vo["img"]); ?>" alt="点击修改图片" style="width:60px;height:60px">
                                        </div>
                                     </div>
                                  </div>
                                </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="userphone" placeholder="密码" name="userphone" value="<?php echo ($vo["phone"]); ?>">
                                      <input type="hidden" class="form-control" id="userid" placeholder="密码" name="userid" value="<?php echo ($vo["id"]); ?>">
                                  </div>
                                  <div class="form-group">
                                      <label for="exampleInputPassword1">用户组</label>
                                      <select class="form-control m-bot15" id="groupid" name="groupid">
                                         <?php if(is_array($usergroup)): $i = 0; $__LIST__ = $usergroup;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i; if($vo['groupid'] == $res['id']){ $sel="selected='selected'"; }else{ $sel=""; } ?>
                                            <option <?php echo ($sel); ?> value="<?php echo ($res["id"]); ?>"><?php echo ($res["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                      </select>
                                  </div>
...
<div class="modal fade" id="avatar-modal" aria-hidden="true" aria-labelledby="avatar-modal-label" role="dialog" tabindex="-1">
  <div class="modal-dialog modal-lg"  style="width:1000px;">
    <div class="modal-content">
      <form class="avatar-form" action="<?php echo U('User/postimg',array('id'=>$uid));?>" enctype="multipart/form-data" method="post">
