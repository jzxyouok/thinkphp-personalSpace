    ...
    <div class="container">
      ...
      <form class="form-signin">
        ...
        <div class="login-wrap">
            <input type="text" class="form-control" placeholder="用户账号" autofocus name="adminname" id="adminname" readonly="true" value="<?php echo ($adminname); ?>">
            ...
            <label class="checkbox">
                <span class="pull-right"> <a href="<?php echo U('Admin/login/zhmm');?>"> Forgot Password?</a></span>
            </label>
...
<script type="text/javascript">
    ...
    function dologin(){
        ...
        var ajaxadminUrl='<?php echo U("Admin/Login/editpwdadmin");?>'; 
