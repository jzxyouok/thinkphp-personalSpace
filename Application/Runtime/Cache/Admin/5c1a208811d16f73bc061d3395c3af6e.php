              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a class="" href="<?php echo U('Admin/User/group');?>">用户组</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                  ...
                  <div class="col-sm-6">
                      <section class="panel">
                        ...
                        <?php if(is_array($data)): $key = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr>
                                  ...
                                  <td>
                                     <button class="btn btn-danger btn-xs" onClick="window.location.href='<?php echo U('User/deleteusergroup','','');?>/id/<?php echo ($vo["id"]); ?>'"><i class="icon-trash "></i></button>
                                  </td>
                                  <td></td>
                              ...
                              <form class="form-inline" role="form">
                                  <div class="form-group">
                                      ...
                                      <select class="form-control m-bot15" id="groupid" name="groupid">
                                         <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i;?><option <?php echo ($sel); ?> value="<?php echo ($res["id"]); ?>"><?php echo ($res["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                      </select>
                                  </div>
                                  <br/>
                                  <div class="form-group">
...
<!-- 密码修改 -->
    <script type="text/javascript">
	    function addusergroup(){
			...
			var ajaxgroupUrl='<?php echo U("User/addgroup");?>'; 
			if(groupname==''){
				layer.msg('请填写用户组名！');
			}
			<!--ajax提交-->
	...
	function editusergroup(){
			...
			var ajaxgroupUrl='<?php echo U("User/editgroup");?>'; 
			if(groupname==''){
				layer.msg('请填写用户组名！');
			}
			<!--ajax提交-->
