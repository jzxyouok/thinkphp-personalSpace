        ...
        <div class="vertical-center sun">
             <div class="container">
                <div class="row">
                    <div class="action">
                        <div class="col-sm-12">
                        <?php if(is_array($webinformation)): $i = 0; $__LIST__ = $webinformation;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["type"] == image): ?><h1 class="title"><?php echo ($vo["title"]); ?></h1>
        ...
        <div class="container">
            <div class="row">
                <ul class="portfolio-filter text-center">
                    <li><a class="btn btn-default <?php echo ($ops); ?>" href="<?php echo U('Image/lst','','');?>/id/<?php echo ($tid); ?>" id="imgtype">All</a></li>
                <?php if(is_array($alumbdata)): $i = 0; $__LIST__ = $alumbdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a class="btn btn-default <?php echo ($vo["op"]); ?>" href="" onClick="window.location.href='<?php echo U('Image/lst','','');?>/id/<?php echo ($tid); ?>/aid/<?php echo ($vo["id"]); ?>'" id="imgtype"><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul><!--/#portfolio-filter-->
                    
                <div class="portfolio-items">
             <?php if(is_array($imgdata)): $i = 0; $__LIST__ = $imgdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-xs-6 col-sm-4 col-md-3 portfolio-item branded logos">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-single">
                                <div class="portfolio-thumb">
                                    <img src="/Public/img/uploads/imgs/<?php echo ($vo["img"]); ?>" class="img-responsive" alt="" style="width:261px;height:269px;">
                                </div>
                            ...
                            <div class="portfolio-info ">
                                <h2 style="text-align:center;"><?php echo ($vo["describe"]); ?></h2>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="testimonial bottom">
                        <h2>视频</h2>
                        <div class="media">
                <?php if(is_array($newvideo)): $key = 0; $__LIST__ = $newvideo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><div class="media-body">
                           <!-- 存放视频 -->
