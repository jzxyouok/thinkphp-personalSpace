        ...
        <div class="vertical-center sun">
             <div class="container">
                <div class="row">
                    <div class="action">
                        <div class="col-sm-12">
                        <?php if(is_array($webinformation)): $i = 0; $__LIST__ = $webinformation;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["type"] == filetype): ?><h1 class="title"><?php echo ($vo["title"]); ?></h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9 col-sm-7">
                    <div class="row">
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-sm-12 col-md-12">
                            <div class="single-blog single-column">
                                <div class="post-thumb">
                                    <a href="<?php echo U('Article/articlelist','','');?>/rid/<?php echo ($vo["id"]); ?>"><img src="/Public/img/uploads/fileimg/<?php echo ($vo["img"]); ?>" style="width:850px;height:400px;"></a>
                                    <div class="post-overlay">
                                       <span class="uppercase"><a href="<?php echo U('Article/articlelist','','');?>/rid/<?php echo ($vo["id"]); ?>"><?php echo ($vo["day"]); ?> <br><small><?php echo ($vo["month"]); ?></small></a></span>
                                   </div>
                                </div>
                                <div class="post-content overflow">
                                    <h2 class="post-title bold"><a href="<?php echo U('Article/articlelist','','');?>/rid/<?php echo ($vo["id"]); ?>"><?php echo ($vo["filename"]); ?></a></h2>
                                    <h3 class="post-author"><a href="<?php echo U('Article/articlelist','','');?>/rid/<?php echo ($vo["id"]); ?>">作者：<?php echo ($vo["adminname"]); ?></a></h3>
                                    <p><?php echo ($vo["describe"]); ?></p>
                                    <a href="<?php echo U('Article/articlelist','','');?>/rid/<?php echo ($vo["id"]); ?>" class="read-more">View More</a>
                                    <div class="post-bottom overflow">
                                        <ul class="nav navbar-nav post-nav">
                                            <li><a href="<?php echo U('Article/articlelist','','');?>/rid/<?php echo ($vo["id"]); ?>"><i class="fa fa-tag"></i><?php echo ($vo["filetype"]); ?></a></li>
                                            <li><a href="<?php echo U('Article/articlelist','','');?>/rid/<?php echo ($vo["id"]); ?>"><i class="fa fa-heart"></i><?php echo ($vo["reader"]); ?></a></li>
                                            <li><a href="<?php echo U('Article/articlelist','','');?>/rid/<?php echo ($vo["id"]); ?>"><i class="fa fa-comments"></i><?php echo ($vo["thumbs"]); ?></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-3 col-sm-5">
                    <div class="sidebar blog-sidebar">
                        <div class="sidebar-item  recent">
                            <h3>评论</h3>
                       <?php if(is_array($pinglun)): $i = 0; $__LIST__ = $pinglun;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="media">
                                <div class="pull-left">
                                    <a href="#"><img src="/Public/img/uploads/userimg/<?php echo ($vo["userimg"]); ?>" style="width: 52px;height: 52px;" /></a>
                                </div>
                                <div class="media-body">
                                    <h4><a href="#"><?php echo ($vo["content"]); ?></a></h4>
                                    <p><?php echo ($vo["username"]); ?>：<?php echo (date('Y-m-d H:i:s',$vo["time"])); ?></p>
                                </div>
                            </div><?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
